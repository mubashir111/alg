                    ...
                    <div class='lg:col-span-1 lg:h-fit w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6 xl:gap-8'>
                        ...
                        <div class='w-full p-3 md:p-5 flex flex-col gap-3 xl:gap-4 bg-[#F0F5F7] rounded-[16px]'>
                            ...
                            <div class='flex flex-col gap-2'>
                                <a href="{{ asset('ALG-Corporate-Profile.pdf') }}" download="ALG-Corporate-Profile.pdf" class='group w-full p-3 flex gap-2 items-center font-normal Medium-text text-[#103440] hover:text-[#36A5C2] tracking-[0.2px] hover:bg-[#FFFFFF] Hover-effect rounded-[8px] cursor-pointer'>
